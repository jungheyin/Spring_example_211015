...
<body>
	<div class="container">
		...
		<form method="post" action="/lesson04/ex01/add_user"> <!--  insert를 하는 controller -->
			...
			<div class="form-group">
				<label for="eamil"><b>이메일</b></label>
				<input type="eamil" id="eamil" name="eamil" class="form-control col-3" placeholder="이메일을 입력하세요.">
			</div>
			<div class="form-group">
				<label for="introduce"><b>자기소개</b></label>
				<textarea id="introduce" name="introduce" class="form-control col-3" row="10" ></textarea>
			</div>
